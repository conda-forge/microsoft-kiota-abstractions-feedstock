About microsoft-kiota-abstractions-feedstock
============================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/microsoft-kiota-abstractions-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/microsoft-kiota-abstractions-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add microsoft-kiota-abstractions
# for installing globally
pixi global install microsoft-kiota-abstractions
```
...
It is possible to list all of the versions of `microsoft-kiota-abstractions` available on your platform:
...
```
pixi search microsoft-kiota-abstractions --channel conda-forge
```
